...
.text
main:
# register NOT to be used x0 tot x4 and x10 to x17; reason to be explained later
# register that we can used x5 to x9 and x18 to x31; reason to be explained later
